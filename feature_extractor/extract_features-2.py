...
# chunk_size = 1000
# save_to = "arabic_books"

# for i in range(int(len(data)/chunk_size)):
#   chunk = data[i*chunk_size:((i+1)*chunk_size)]
#   makedirectory(save_to)
#   ugr_extract(chunk["English review"],min_doc_freq=3,saveto=save_to,chunk_n=i)

galc_extract(data["English review"], saveto="arabic_books")
